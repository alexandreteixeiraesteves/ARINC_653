...
gcc -std=c99 -I$(pwd) -I'build' -c complex_c/complex_types.c complex_c/complex.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -c complex_io_types.c complex_io.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -c complexes_c/complexes_types.c complexes_c/complexes.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -I'complex_c' -c twiddle_init.c twiddle.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -c bitrev.c complex_vec_io.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -c fft_c/fft.c fft_c/fft_types.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -I'bitrev_c' -c fft_test_c/fft_test.c fft_test_c/fft_test_types.c -lm -lc -lgcc
gcc -std=c99 -I$(pwd) -I'build' -I'complex_c' -I'fft_c' -I'bitrev_c' -c main.c -lm -lc -lgcc

gcc -std=c99 -I'build' *.o -o main -lm -lc -lgcc
